...
const ContainerInternship: FC = () => {
  return (
    <>
      <Head>
        <title>Informasi Magang - Wikusama Hotel</title>
        <meta name="robots" content="follow, index" />
        <meta
          name="description"
          content="Wikusama Hotel menyediakan serta memfasilitasi program magang di mana siswa maupun mahasiswa bisa menggunakan kesempatan ini untuk melatih skill dan melakukan pengembangan diri dalam dunia kerja."
        />
        <meta
          property="og:url"
          content="https://wikusamahotel.com/internship"
        />
        ...
        <meta
          ...
          content="Wikusama Hotel menyediakan serta memfasilitasi program magang di mana siswa maupun mahasiswa bisa menggunakan kesempatan ini untuk melatih skill dan melakukan pengembangan diri dalam dunia kerja."
        />
        <meta property="og:title" content="Informasi Magang - Wikusama Hotel" />
        <meta
          property="og:image"
        ...
        <meta
          name="twitter:title"
          content="Informasi Magang - Wikusama Hotel"
        />
        <meta
                ...
                <div className="w-full px-4">
                  ...
                  <div className="max-w-3xl">
                    ...
                    <p className="text-gray-500 xl:text-lg leading-relaxed text-justify mb-5">
                      Wikusama Hotel menyediakan serta memfasilitasi program
                  ...
                  <div className="mb-3 lg:mb-5">
                    ...
                    <ul className="list-disc px-4">
                      ...
                      <li>
                        <p>Resepsionis</p>
                        <p className="text-gray-500">
                          Skill: Perhotelan, Administrasi
                        </p>
                      </li>
                      <li>
                        <p>Housekeeping</p>
                        <p className="text-gray-500">Skill: Perhotelan</p>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="mb-3 lg:mb-5">
                    ...
                    <div className="max-w-3xl">
                      <p className="text-gray-500 xl:text-lg leading-relaxed text-justify mb-5">
                        ...
                        Wikusama Hotel, atau bisa langsung datang ke{' '}
                        <a
