...
import SummaryReviews from './Summary';
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 px-4">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="border-t pt-6">
                <button
                  type="button"
                  className="flex items-center text-primary hover:text-primarydark active:text-primary font-semibold transition duration-100 gap-0.5"
                >
                  Baca Semua
                </button>
              </div>
